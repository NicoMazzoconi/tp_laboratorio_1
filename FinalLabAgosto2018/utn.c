...
/** \brief pide un dni y verifica si es correcto
 *
 * \param str char* donde guardar el dni
 * \param mensaje char* mensaje al mostrar antes de ingresar el dni
 * \param error char* mensaje de error al mostrar si es incorrecto
 * \param intentos int cantidad de vec que puede intentar
...
/** \brief Pide un cuit y verifica que sea valido
 *
 * \param requestMessage[] char Mensaje a al pedir el cuit
 * \param errorMessage[] char Mensaje al ingresar un cuit invalido
 * \param errorMessageLenght[] char Mensaje al ingresar un cuit demasiado corto o largo
 * \param input[] char string donde guardar el cuit
 * \param minLength int la cantidad minima de numeros
 * \param maxLenght int la cantidad maxima de numeros
